...
export default function EditUserForm({
  ...
  user: UserProps | null | undefined; id: string
}) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className=" pb-[100px] h-[100svh] flex flex-col justify-between">
        <div className="">
          <FormField control={form.control} name="firstName" render={({ field }) => (
            <FormItem className=" relative" >
              <BiRename className=" top-1/2 -translate-y-1/2  absolute w-6 h-6" />
              <Input {...field} className=" text-[18px] pl-[50px] placeholder:font-bold rounded-none py-[30px] border-t-0 border-l-0 border-r-0" />
            </FormItem>
          )} />
          ...
          <FormField control={form.control} name="email" render={({ field }) => (
            <FormItem className=" relative">
              ...
              <Input disabled {...field} className=" text-[18px] pl-[50px] placeholder:font-bold rounded-none py-[30px] border-t-0 border-l-0 border-r-0" />
            </FormItem>
          )} />
          ...
          <FormField name="dob" control={form.control} render={({ field }) => (
            <FormItem>
              <Popover open={open} onOpenChange={setOpen}>
                ...
                <PopoverContent className=" bg-secondary text-white border-0 overflow-hidden p-0" align="start">
                  <Calendar
                    mode="single"
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className=" mt-[25px]">
                <p className=" text-[20px]">Add a profile picture</p>
                <FormControl>
                  <div className="">
                    <input
                      type="file"
        ...
        <div className=" mt-[20px]">
          <Button disabled={loading} type="submit" className="w-full rounded-[12px] font-semibold py-[24px]" >
            {loading ? (
